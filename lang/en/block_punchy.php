...
$string['defaulttext'] = "<p>A project of the Digital University allied to a consortium of partners:<p>
                            <ul>
                                ...
                                <li>To initiate a general, systemic and collective approach aimed at the creation and sharing of digital educational resources with a large potential for reuse, revision and adaptation to various contexts</li>
                            </ul>";
